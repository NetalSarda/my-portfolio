...
export default function WorkExperience() {
  return (
    <div className="min-h-screen bg-[#0a0a1a] px-4 py-16 text-white md:px-8 lg:px-16">
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 text-center">
          <h2 className="mb-2 text-sm uppercase tracking-wider text-gray-400">WHAT I HAVE DONE SO FAR</h2>
          <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl">Work Experience.</h1>
        </div>

        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-[50%] top-0 hidden h-full w-px -translate-x-[50%] bg-white/20 md:block" />

          {/* Mobile timeline line */}
          <div className="absolute left-4 top-0 h-full w-px bg-white/20 md:hidden" />
            ...
            {timelineData.map((item, index) => (
              <div key={index} className="relative">
                ...
                <div className="flex max-w-[calc(100%-20px)] md:hidden">
                  <div className="relative flex h-8 w-8 items-center justify-center">
                    <div className="absolute flex h-8 w-8 items-center justify-center rounded-full bg-white/10">

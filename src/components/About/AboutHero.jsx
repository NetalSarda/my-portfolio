    ...
    <div className="w-full h-auto lg:h-[60vh] sm:my-12 gap-4 flex flex-col-reverse lg:flex-row p-4 sm:p-8">
      <div className="flex-1 flex flex-col justify-center h-full sm:px-8 sm:py-4 sm:space-y-4">
        ...
        <p className="text-lg">
          ...
          ipsum odio omnis maxime? Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Aliquid exercitationem voluptas quaerat obcaecati at
          reiciendis consectetur ipsum odio omnis maxime?
        </p>
        <div>
          <p>Education</p>

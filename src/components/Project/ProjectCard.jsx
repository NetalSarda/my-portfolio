...
const ProjectCard = () => {
  return (
    <div className="w-full h-auto lg:h-[60vh] mt-4 gap-4 flex flex-col lg:flex-row px-20 py-8">
      <div className="w-3/4 flex flex-col justify-center h-full px-8 py-4 space-y-4">
        ...
        <div className="flex w-1/5 justify-evenly gap-4">
      ...
      <div className="p-4 w-1/4 h-full flex justify-center items-center">
        {/* Image */}
        <img

    ...
    <div className="h-full relative">
      ...
      <div className=" max-w-4xl relative z-10">
        ...
        <div className="w-full flex flex-col space-y-2">
          {projects.filter((t,index)=>index < 3).map((project, index) => (
            <div
              key={index}
            ...
            >
              <div
                ...
                className={`w-full flex justify-between items-center px-6 py-5 cursor-pointer transition-colors duration-300 ${
                  activeTab === index ? "border-b border-gray-700 hidden" : ""
                }`}
              >
                <h3
